...
export default {
    ...
    DESIGNER: {
        ...
        THRUSTER: {
            EFFICIENCY_TOOLTIP:
                '100% КПД достижимо только при идеальной симметрии корабля, что почти невозможно.',
        ...
        CALCULATION: {
            ...
            FORWARD_SPEED_FULL_TOOLTIP:
                'Полная загрузка считается по самой тяжёлой руде (26т/стак - Лукий)',
            ...
            TOTAL_HEAT_TOOLTIP:
                'Тепло расчитано как если бы генераторы были присоеденены друг к дуруг. Обычно +25 тепла на каждый следующий генератор',
